...
| 1.4 | Create `frontend/.env.example` documenting all four variables, with a runtime guard that fails fast on a missing required one | new |
...
| 1.7 | Frontend coverage ratchet, matching the backend's | 2089 |
